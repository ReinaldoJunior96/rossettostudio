         ...
         <div class="relative rounded-3xl bg-white/80 backdrop-blur-xl ring-1 ring-black/5 shadow-[0_20px_60px_-20px_rgba(17,24,39,0.25)] p-6 md:p-8 w-full max-w-lg">
            ...
            <form class="space-y-5" method="post">
               ...
               <!-- <p class="pt-1 text-center text-sm text-gray-600">
                  Novo por aqui?
                  <a class="font-semibold text-purple-700 hover:underline"
                  ...
                  <form method="post" class="space-y-5">
                     ...
                     <?php if ('no' === get_option('woocommerce_registration_generate_password')) : ?>
                        ...
                        <div>
                           ...
                           <!-- barra de força (leve e opcional) -->
                     ...
                     <?php
                     // IMPORTANTE:
                     // Você já adiciona vários campos extras + "Confirmar senha" via hook `woocommerce_register_form` no functions.php.
                     // Eles serão injetados aqui automaticamente. Mantemos este hook para não duplicar campos.
                     ?>
            ...
            <script>
               (function() {
                  ...
                  if (btn && pass) {
                     ...
                     // força simples (client-side, apenas UX)
